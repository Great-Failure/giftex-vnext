/**
 * v2 Data Model — Exchange-Centric Architecture (frontend mirror)
 *
 * This file MIRRORS `api/src/shared/v2/types.ts`. Keep them in sync manually,
 * matching the v1 convention for `src/lib/types.ts` ↔ `api/src/shared/types.ts`.
 * The API file is the source of truth; copy changes from there to here.
 *
 * See `docs/data-model-v2.md` and `docs/data-model-v2-erd.md` for the design
 * rationale, Cosmos partitioning strategy, status transitions, and ADR-001
 * compliance map.
 */
 ...
 * shape may be revisited during #10.
 */
